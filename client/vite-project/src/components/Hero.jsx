...
const Hero = () => {
  return (
    <section className="w-full relative overflow-hidden pt-36">
      {/* Purple Background */}
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-6 lg:px-16 py-12">
        ...
        <div className="max-w-xl text-white">
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight animate-bounce-up">
        ...
        <div className="relative mt-10 lg:mt-0 w-full lg:w-[50%] flex justify-center">
          ...
          {/* Floating Cards */}
          <div className="absolute top-6 right-4 w-64 z-20 shadow-md bg-white rounded-lg p-3 text-sm hidden lg:block animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <p className="font-semibold text-gray-800">Order 1</p>
            <p className="text-gray-500">We've received your order!</p>
          </div>
          <div className="absolute top-32 -right-10 w-64 z-20 shadow-md bg-white rounded-lg p-3 text-sm hidden lg:block animate-slide-up" style={{ animationDelay: '0.4s' }}>
            <p className="font-semibold text-gray-800">Order 2</p>
            <p className="text-green-600">Order Accepted ✅</p>
          </div>
          <div className="absolute top-72 -right-14 w-64 z-20 shadow-md bg-white rounded-lg p-3 text-sm hidden lg:block animate-slide-up" style={{ animationDelay: '0.6s' }}>
